...
async def main():
    print("="*70)
    print("UPLOAD HEX.CO SCREENSHOT TO NEW MIRO BOARD")
    print("="*70)
    ...
    async with async_playwright() as p:
        ...
        print("="*70)
        print("\nLog in and the automation will continue automatically...")
        ...
        try:
            ...
            if '/app/' in page.url:
                ...
                print("\nBrowser staying open - please log in manually")
                print("Then close the browser and run this script again.")
