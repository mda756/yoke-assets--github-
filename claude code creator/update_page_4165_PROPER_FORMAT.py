"""
Update Page 4165 with PROPER GitHub formatting rules
Following ACF-HTML-GENERATOR-RULESET-FINAL.txt
"""
...
def main():
    ...
    print(f"Updating page {page_id} with PROPER formatting...")
...
<h3><span style="color: #003366;"><em>The data speaks: 95% of CPD measures knowledge only. 46% measures practice performance. (ACCME 2024)</em></span></h3>"""
    ...
    panels.append({
        ...
        "content_block": """<h1><span style="color: #003366;"><strong>The Vicious Cycle</strong></span></h1>
...
<h3><span style="color: #003366;"><em>Not separate pieces. An integrated system.</em></span></h3>"""
    ...
    # CONTENT PANEL - What You Get
    panels.append({
        "acf_fc_layout": "content_panel",
        "alignment": "left",
        "background_colour": False,
        "content_block": """<h1><span style="color: #003366;"><strong>What You Get</strong></span></h1>
...
<h3><span style="color: #003366;"><em>Better engagement drives better insights, which drives more effective gap closure.</em></span></h3>"""
    ...
    panels.append({
        ...
        "alignment": "left",
        "background_colour": False,
        "content_block": """<h1><span style="color: #003366;"><strong>4 Steps to Start the Virtuous Cycle</strong></span></h1>
...
<h3><span style="color: #003366;"><em>Timeline: 2-4 weeks to launch.</em></span></h3>"""
    ...
    panels.append({
        ...
        "alignment": "left",
        "background_colour": False,
        "content_block": """<h1><span style="color: #003366;"><strong>Why It Works — Built on Research</strong></span></h1>
...
<p style="text-align: center;"><a class="button" href="/contact">Book Your 30-Minute Meeting</a></p>"""
    ...
    print(f"Created {len(panels)} properly formatted panels")
    ...
    try:
        ...
        print("SUCCESS: Page updated with proper formatting!")
